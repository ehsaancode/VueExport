...
const QColumnChart = ({
  ...
  showLegend = "true", // toggle the legend
  showTooltip = "true",
  ...
  xAxisLineWidth,
  yAxisLineWidth,
  gridLineXColor = "#E0E0E0",
  gridLineYColor = "#E0E0E0",
  ...
  tailwaindClasses,
    ...
    // Column specific
  barSpacing = 25, // spacing between bars
  ...
  return (
    <div ref={containerRef} className={`flex flex-col ${outerItemsClass}`}>
      {/* <div style={marginStyle}> */}
        <div
          style={{ ...borderedContainerStyle, ...marginStyle }}
              ...
              return (
                <g key={i}>
                  <rect
                    ...
                    className="cursor-pointer opacity-100 transition-opacity hover:opacity-100"
