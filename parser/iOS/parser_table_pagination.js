...
const commonDefault = require('../Common/parse_default_table_pagination');
...
class ParserTablePagination {
     ...
     async parsePage(startingColum, fileName, jsonObjects, parentWidth, parentHeight, parantMainAlignment, parantCrossAlignment) {
          for (const index in jsonObjects) {
               ...
               await createPageDesign.pageDesign(startingColum + 1, fileName, jsonObj, parentWidth, parentHeight, parantMainAlignment, parantCrossAlignment, "QTablePagination");
