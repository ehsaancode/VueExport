...
class AndroidParserTableWraper {
                    ...
                    ' '.repeat(this.startingColum) +
                         ...
                         if (content == "success") {
                              ...
                              if (this.jsonObjects["children"] != null && this.jsonObjects["children"].length > 0) {
                                   //
                                   // console.log(`in design : parent width: ${widthHeight.width ?? this.parentWidth} || parent height: ${widthHeight.height ?? this.parentHeight}`)
     ...
     async parsePage(startingColum, fileName, jsonObjects, parentWidth, parentHeight) {    
          for (const index in jsonObjects) {
               ...
               await createPageDesign.pageDesign(startingColum, fileName, jsonObj, parentWidth, parentHeight, "QTableWrapper");
          }
     }
