...
async function parseLayout(
  ...
  let projectPagePath = `${vueProjectPath}/${projectId}/vue_project/src/layouts/${layoutName}`;
...
async function indexPage(projectId, layoutName) {
  ...
  let layoutPathDesktop = `${vueProjectPath}/${subProjectPath}/vue_project/src/layouts/${layoutName}/Desktop/${layoutName}.jsx`;
  let layoutPathMobile = `${vueProjectPath}/${subProjectPath}/vue_project/src/layouts/${layoutName}/Mobile/${layoutName}.jsx`;
  let layoutPathIndex = `${vueProjectPath}/${subProjectPath}/vue_project/src/layouts/${layoutName}/${layoutName}_index.jsx`;
...
async function tabletLayout(
  ...
  let subProjectPath = projectId;
  let layoutPathMobile = `${vueProjectPath}/${subProjectPath}/vue_project/src/layouts/${layoutName}/Tablet/${layoutName}.jsx`;
...
async function desktopLayout(
  ...
  try {
    ...
    let subProjectPath = projectId;
    let pageName = `${vueProjectPath}/${subProjectPath}/vue_project/src/layouts/${layoutName}/${layoutName}_desktop.jsx`;
...
async function mobileLayout(
  ...
  try {
    ...
    let subProjectPath = projectId;
    let pageName = `${vueProjectPath}/${subProjectPath}/vue_project/src/layouts/${layoutName}/${layoutName}_mobile.jsx`;
