const blockImage = require("./vue_parser_block_image");
const blockButton = require("./vue_craete_block_button");
const parserFullWidth = require("./vue_parser_full_width");
const parserDiv = require("./vue_parser_div");
const parserFlex = require("./vue_parser_flex");
const parserMainCanvas = require("./vue_parser_main_canvas");
const parserIncrementCounter = require("./vue_parser_increment_counter");
const parserAccordion = require("./vue_parser_accordion");
const parserAccordionItem = require("./vue_parser_accordionItem");
const parserWrap = require("./vue_parser_wrap");
const parserTabBar = require("./vue_parser_tabBar");
const parserTab = require("./vue_parser_tab");
const parserTabBody = require("./vue_parser_tabBody");
const parserTabHeader = require("./vue_parser_tabHeader");
const parserFloatingButton = require("./vue_parser_floating_button");
const parserDrawer = require("./vue_parser_drawer");
const parserStickyHeader = require("./vue_parser_sticky_header");
const parserHeaderBar = require("./vue_parser_header_bar");
const parserForm = require("./vue_parser_form");
const parserFormInputElement = require("./vue_parser_form_input_element");
const parserInputText = require("./vue_parser_input_text");
const parserInputTextEmail = require("./vue_parser_input_text_email");
const parserInputTextNumber = require("./vue_parser_input_text_number");
const parserRadio = require("./vue_parser_radio");
const parserCheckBox = require("./vue_parser_check_box");
const parserDropdown = require("./vue_parser_drop_down");
const parserTextarea = require("./vue_parser_textarea");
const parserNSection = require("./vue_parser_nSection");
const parserElement = require("./vue_parser_element");
const parserSection = require("./vue_parser_section");
const parserMenuBar = require("./vue_parser_menuBar");
const parserHMenuItem = require("./vue_parser_hMenuItem");
const parserStack = require("./vue_parser_stack");
const parserParallax = require("./vue_parser_parallax");
const parserGroupParallax = require("./vue_parser_group_parallax");
const parserRow = require("./vue_parser_row");
const parserRepeat = require("./vue_parser_repeat");
const parserTableWrapper = require("./vue_parser_table_wrapper");
const parserTableSearch = require("./vue_parser_table_search");
const parserInputSearch = require("./vue_parser_input_search");
const parserIcon = require("./vue_parser_icon");
const parserTable = require("./vue_parser_table");
const parserMarquee = require("./vue_parser_marquee");
const parserBlockText = require("./vue_parser_block_text");
const parserHyperTextH6 = require("./vue_parser_hypertext_textH6");
const parserHyperTextH5 = require("./vue_parser_hypertext_textH5");
const parserHyperTextH4 = require("./vue_parser_hypertext_textH4");
const parserHyperTextH3 = require("./vue_parser_hypertext_textH3");
const parserHyperTextH2 = require("./vue_parser_hypertext_textH2");
const parserHyperTextH1 = require("./vue_parser_hypertext_textH1");
const parserSlider = require("./vue_parser_slider");
const parserTablePagination = require("./vue_parser_table_pagination");
const parserTablePaginationButton = require("./vue_parser_table_pagination_button");
const parserPageIndicator = require("./vue_parser_pageIndicator");
const parserTablePaginationInfo = require("./vue_parser_table_pagination_info");
const parserTablePaginationRPP = require("./vue_parser_table_pagination_RPP");
const parserTableFilter = require("./vue_parser_table_filter");
const parserTableSort = require("./vue_parser_table_sort");
const parserMap = require("./vue_parser_map");
const parserBottomMenu = require("./vue_parser_bottom_menu");
const parserVideo = require("./vue_parser_video");
const parserNavbar = require("./vue_parser_navbar");
const parserGallery = require("./vue_parser_gallery");
const parserMasonary = require("./vue_parser_masonary");
const parserProgressbarWithPercentage = require("./vue_parser_progressbar_with_percentage");
const parserProgressbarWithStepper = require("./vue_parser_progressbar_with_stepper");
const parserDashedProgressbar = require("./vue_parser_dashed_progress_bar");
const parserProgressbarWithSlider = require("./vue_parser_progress_bar_with_slider");
const parserBackDrop = require("./vue_parser_back_drop");
const parserCarousel = require("./vue_parser_carousel");

const parserLineChart = require("./vue_parser_line_chart")
const parserAreaChart = require("./vue_parser_area_chart")
const parserPieChart = require("./vue_parser_pie_chart")
const parserBarChart = require("./vue_parser_bar_chart")
const parserColumnChart = require("./vue_parser_column_chart")

const parserPage = require("./vue_parser_page");
const parserColumnHeaders = require("./vue_parser_column_headers");
const parserColumnHeader = require("./vue_parser_column_header");
const parserTableRows = require("./vue_parser_table_rows");
const parserTableRow = require("./vue_parser_table_row");
const parserTableCell = require("./vue_parser_table_cell");
