...
class ParserDiv {
  ...
  async parseDiv() {
    ...
    let defaultObject = (await defaultParseDiv.getDefaultObject()) ?? "";
  ...
  async parsePage(
    ...
    for (const index in jsonObjects) {
      ...
      await createPageDesign.pageDesign(
        ...
        this.isAbsoluteValue,
        this.parantType == "QHMenuItem" ? "QHMenuItem" : (this.parantType == "QFormItem" || this.parantType == "QForm") ? this.parantType : "QDiv",
        '',
