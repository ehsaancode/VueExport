...
class ParserProgressbarWithStepper {
  constructor(
    projectId = 0,
    pageId = 0,
    startingColum,
  ...
  async parseProgressbarWithStepper() {
    ...
    await commonUtilsReact.generateVueTemplate({
      componentName: "QProgressbarWithStepper",
      isSelfClosing: false,
...
module.exports = {
  // parseProgressbarWithStepper,
  ParserProgressbarWithStepper,
};
