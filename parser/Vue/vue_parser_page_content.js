...
async function parsePageContent(
  ...
  let projectPagePath = `${vueProjectPath}/${projectId}/vue_project/src/pages/${pageName}`;
...
async function indexPage(projectId, pageName) {
  ...
  let pagePathDesktop = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/Desktop/${pageName}.vue`;
  let pagePathTablet = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/Tablet/${pageName}.vue`;
  let pagePathMobile = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/Mobile/${pageName}.vue`;
  let pagePathIndex = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/${pageName}_index.vue`;

  const data = {
    importDesktopPage: (await readWriteFile.fileExists(pagePathDesktop))
      ? `import ${pageName}_desktop from \"./Desktop/${pageName}.vue\";`
      : "",

    importTabletPage: (await readWriteFile.fileExists(pagePathTablet))
      ? `import ${pageName}_tablet from \"./Tablet/${pageName}.vue\";`
      : "",

    importMobilePage: (await readWriteFile.fileExists(pagePathMobile))
      ? `import ${pageName}_mobile from \"./Mobile/${pageName}.vue\";`
      : "",
    Page: pageName,
...
async function desktopPage(
  ...
  /*try {
    ...
    let subProjectPath = projectId;
    let pageName2 = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/Desktop/${pageName}.jsx`;
...
async function parseDesktopPage(
  ...
  if (jsonObjects?.length > 0) {
    let pagePath = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/${pageName}_desktop.vue`;
        ...
        await readWriteFile
          ...
          .then(async (content) => {
            if (content == "success") {
              ...
              Promise.resolve("success").then(async (content) => {
                if (content == "success") {
...
async function tabletPage(
  ...
  let subProjectPath = projectId;
  let pagePathDesktop = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/Tablet/${pageName}.vue`;
...
async function mobilePage(
  ...
  let subProjectPath = projectId;
  let pagePathDesktop = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/Mobile/${pageName}.vue`;
...
async function parseMobilePage(
  ...
  if (jsonObjects?.length > 0) {
    const jsonObject = jsonObjects[0];
    let pagePath = `${vueProjectPath}/${subProjectPath}/vue_project/src/pages/${pageName}/${pageName}_mobile.vue`;
    let projectTemplatePath = `${vueProjectPath}/${subProjectPath}/template`;
    let sourceTopPage = `${projectTemplatePath}/pageTopTemplate.txt`;
    await readWriteFile.copyPasteFileContent(sourceTopPage, pagePath);
    await readWriteFile.replaceWordInFile(
