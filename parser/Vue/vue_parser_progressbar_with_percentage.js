...
class ParserProgressbarWithPercentage {
  constructor(
    projectId = 0,
    pageId = 0,
    startingColum,
  ...
  async parseProgressbarWithPercentage() {
    ...
    await commonUtilsReact.generateVueTemplate({
      componentName: "QProgressbarWithPercentage",
      isSelfClosing: false,
...
module.exports = {
  // parseProgressbarWithPercentage,
  ParserProgressbarWithPercentage,
};
